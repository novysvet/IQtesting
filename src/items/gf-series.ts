 ...
 * b spans -2.4 to +3.4. Parameters are AUTHORED ESTIMATES, not calibrated.
 */
export const figureSeries: Subtest = {
  ...
  },
  {
    ...
    a: 1.4, b: -0.1, c: 0.2,
    // rule: shape cycles triangle, square, circle, then repeats
    prompt: "Which figure comes next in the series?",
    options: ["cir:1:none:0", "hex:1:none:0", "dia:1:none:0", "tri:1:none:0", "sq:1:none:0"],
    answer: 4,
  ...
  },
  {
    ...
    a: 1.6, b: 1.1, c: 0.2,
    // rule: four-shape cycle AND fill alternates none/half
    prompt: "Which figure comes next in the series?",
    options: ["hex:1:none:0", "tri:1:half:0", "cir:1:half:0", "tri:1:none:0", "sq:1:none:0"],
    answer: 3,
    render: { kind: "series", figures: ["tri:1:none:0", "sq:1:half:0", "cir:1:none:0", "hex:1:half:0"] },
  },
  {
  ...
  },
  {
    ...
    a: 2, b: 3.4, c: 0.2,
    // rule: rotation increment grows: +45, +90, +135 -> 135+135=270
    prompt: "Which figure comes next in the series?",
    options: ["arw:1:none:180", "arw:1:none:225", "arw:1:none:315", "arw:1:none:90", "arw:1:none:270"],
    answer: 4,
    render: { kind: "series", figures: ["arw:1:none:0", "arw:1:none:45", "arw:1:none:135"] },
  },
  ],
};
